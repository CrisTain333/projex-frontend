      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 text-[#4A4A68] text-sm max-w-xs">
            ...
            <div className="mt-6 flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-[#F8F9FC] flex items-center justify-center text-[#6B7280] hover:text-[#F97316] hover:bg-[#F97316]/10 transition-colors"
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-[#4A4A68] hover:text-[#F97316] transition-colors"
                    >
                      {link}
                    </a>
                  </li>
