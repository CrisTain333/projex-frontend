            ...
            <div key={step.title} className="relative">
              ...
              <div className="text-center">
                ...
                <div className="relative inline-flex">
                  <div className="w-32 h-32 rounded-full bg-white shadow-lg flex items-center justify-center border border-[#E5E7EB]">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#F97316] to-[#EC4899] flex items-center justify-center">
                      <step.icon className="w-10 h-10 text-white" />
                    </div>
                  </div>
                  {/* Step Number */}
                  <div className="absolute -top-2 -right-2 w-10 h-10 rounded-full bg-[#1A1A2E] flex items-center justify-center">
                ...
                <p className="mt-3 text-[#4A4A68] leading-relaxed max-w-xs mx-auto">
                  {step.description}
                </p>
              </div>
            </div>
