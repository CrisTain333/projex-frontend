        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-lg bg-[#F8F9FC] dark:bg-[#2D2D44] border ${
                    errors.name
                      ? "border-red-500 focus:border-red-500 focus:ring-red-500/20"
                      : "border-[#E5E7EB] dark:border-[#3D3D54] focus:border-[#F97316] focus:ring-[#F97316]/20"
                  } text-[#1A1A2E] dark:text-white placeholder-[#6B7280] focus:outline-none focus:ring-2 transition-all`}
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 rounded-lg bg-[#F8F9FC] dark:bg-[#2D2D44] border ${
                    errors.password
                      ? "border-red-500 focus:border-red-500 focus:ring-red-500/20"
                      : "border-[#E5E7EB] dark:border-[#3D3D54] focus:border-[#F97316] focus:ring-[#F97316]/20"
                  } text-[#1A1A2E] dark:text-white placeholder-[#6B7280] focus:outline-none focus:ring-2 transition-all`}
            ...
            <Button
              ...
              rightIcon={!signupMutation.isPending && <ArrowRight size={18} />}
            >
              Create account
            </Button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              type="button"
              variant="outline"
              onClick={() => window.location.href = authService.getGitHubAuthUrl()}
              className="flex items-center justify-center gap-2"
            >
